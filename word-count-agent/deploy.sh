...
docker build -t ${DOCKER_REGISTRY}/word-count-daemon:${IMAGE_TAG} -f "${SCRIPT_DIR}"/skills/word-count-daemon/actions/word-count-daemon/Dockerfile "${SCRIPT_DIR}"/skills/word-count-daemon/actions/word-count-daemon
...
cortex skills save "${SCRIPT_DIR}"/skills/word-count-daemon/actions/word-count-daemon/skill.yaml -y
