...
DOCKER_IMAGE=spark-batch-predict # Docker Image name

# Registry details
REGISTRY= # Private registry with out 'https//'
...
cortex actions deploy --actionName ${DOCKER_IMAGE}  --actionType job --docker ${IMAGENAME} --project shared --cmd '["scuttle", "python3", "submit_job.py"]'